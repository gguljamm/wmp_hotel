<template>
  <div class="hotelPop" v-if="hotelInfo.imageUrls && Array.isArray(hotelInfo.imageUrls) && hotelInfo.imageUrls.length > 0">
    <div :class="popping ? popping : ''">
      ...
      <ul class="scrollable">
        <li class="img"
          v-for="x in hotelInfo.imageUrls"
          :key="x"
...
export default {
  props: ['popping', 'hotelInfo', 'inputData'],
  data () {
    return {
      format
    }
